...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'custom' => [
            'plugins' => 'advlist autoresize codesample directionality emoticons fullscreen hr image imagetools link lists media table',
            'toolbar' => 'undo redo removeformat | formatselect fontsizeselect | bold italic | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | table hr | image link emoticons | fullscreen',
            'upload_directory' => null,
        ],
