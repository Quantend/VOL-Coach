...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-2 pt-2 border-b-2 border-pink-600 text-lg font-medium leading-5 text-pink-600 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
