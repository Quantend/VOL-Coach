<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-24">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center w-60">
                    <a href="{{ route('home') }}">
                        <img class="ignore w-20" src="{{asset('logo-vol.png')}}">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('inzichten')" :active="request()->routeIs('inzichten')" class="no-underline">
                        {{ __('Inzichten') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('hoofdthema')" :active="request()->routeIs('hoofdthema')" class="no-underline">
                        {{ __("Hoofdthema's") }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                  <x-nav-link :href="route('help')" :active="request()->routeIs('help')" class="no-underline">
                        {{__('Help') }}
                </x-nav-link>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 text-xl">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('inzichten')" :active="request()->routeIs('inzichten')" class="no-underline">
                    {{ __('Inzichten') }}
                </x-responsive-nav-link>
            </div>
