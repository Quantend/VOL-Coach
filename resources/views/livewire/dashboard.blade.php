    ...
    <div class="p-4 sm:p-8 sm:rounded-lg">
        <div>
            ...
            <div class="flex justify-center">
                <p class="font-bold text-pink-400 p-4 bg-white rounded-2xl w-full mx-4 text-center">Nog geen uitdagingen gevonden</p>
            </div>
            @else
            <div class="flex justify-center">
                <button wire:click="toggleVoltooid" class="my-4 px-3 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600">
                    @if ($showVoltooid)
